...
async function generarRespuestaBot(empresaId, mensaje, opts = {}) {
  ...
  try {
    ...
    systemPrompt =
      ...
      '\n\nAUDIOS: Si quieres enviar un audio pregrabado (ej. saludo, promoción), añade una línea [AUDIO: URL] con la URL pública del archivo de audio (formatos: MP3, OGG, AAC, AMR). El sistema enviará el audio por WhatsApp y quitará la línea.';
    const imageParts = [];

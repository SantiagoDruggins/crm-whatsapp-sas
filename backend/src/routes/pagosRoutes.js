...
router.get('/', authMiddleware, empresaEstadoMiddleware, requireCrmPermission('pagos'), asyncHandler(listarMisPagos));
router.post(
  '/',
  authMiddleware,
  empresaEstadoMiddleware,
  requireCrmPermission('pagos'),
  uploadComprobante.single('comprobante'),
  asyncHandler(crearPago)
);
